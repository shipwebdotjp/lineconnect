...
class AudienceProfileTest extends WP_UnitTestCase {
    ...
    public function test_profile属性によるオーディエンスの取得(){
        ...
        $this->assertEmpty(lineconnectAudience::get_audience_by_condition($condition_empty), '空のプロフィールの場合、空のオーディエンスを返すことを確認');

        $condition_no_compare_no_value = json_decode('{"conditions":[{"type":"profile","profile":[{"key":"no_exist_key"}]}]}', true);
        $this->assertEmpty(lineconnectAudience::get_audience_by_condition($condition_no_compare_no_value), '比較演算子が指定されておらず、存在しないキーの場合、空のオーディエンスを返すことを確認');
        ...
        $actual_eq = lineconnectAudience::get_audience_by_condition($conditions_eq);
        ...
        $actual_in = lineconnectAudience::get_audience_by_condition($conditions_in);
        ...
        $actual_not_in = lineconnectAudience::get_audience_by_condition($conditions_not_in);
        ...
        $actual_not_between = lineconnectAudience::get_audience_by_condition($conditions_not_between);
    ...
    public function test_profile属性によるオーディエンスの取得_追加演算子() {
        ...
        $actual_not_equal = lineconnectAudience::get_audience_by_condition($conditions_not_equal);
        ...
        $actual_greater_than = lineconnectAudience::get_audience_by_condition($conditions_greater_than);
        ...
        $actual_greater_equal = lineconnectAudience::get_audience_by_condition($conditions_greater_equal);
        ...
        $actual_less_than = lineconnectAudience::get_audience_by_condition($conditions_less_than);
        ...
        $actual_less_equal = lineconnectAudience::get_audience_by_condition($conditions_less_equal);
        ...
        $actual_not_like = lineconnectAudience::get_audience_by_condition($conditions_not_like);
        ...
        $actual_not_regexp = lineconnectAudience::get_audience_by_condition($conditions_not_regexp);
        ...
        $actual_not_exists = lineconnectAudience::get_audience_by_condition($conditions_not_exists);
