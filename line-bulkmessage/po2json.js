...
const poFile = path.resolve(__dirname, 'languages/line-bulkmessage-ja.po');
const jsonFile = path.resolve(__dirname, 'languages/lineconnect-ja-slc_bulkmessage.json');
