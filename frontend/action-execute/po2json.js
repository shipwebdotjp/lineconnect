...
const poFile = path.resolve(__dirname, 'languages/line-action-execute-ja.po');
const jsonFile = path.resolve(__dirname, 'languages/lineconnect-ja-slc_action-execute.json');
