source ./.env
find . -type d \( -name 'node_modules' -o -name 'dist' -o -name 'vendor' -o -name 'document' -o -name 'line-chat' -o -name 'line-dm' -o -name 'line-richmenu' \) -prune -o \( -type f \( -name '*.php' -or -name '*.js' \) \) -print > list
