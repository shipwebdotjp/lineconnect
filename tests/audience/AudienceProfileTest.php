...
class AudienceProfileTest extends WP_UnitTestCase {
    ...
    public function test_profile属性によるオーディエンスの取得() {
        ...
        $expected_eq = lineconnectTest::getExpectedLineIds(["U_PLACEHOLDER_USERID1ccdbac80ea15"]);
        ...
        $expected_in = lineconnectTest::getExpectedLineIds(["U_PLACEHOLDER_USERID4e7a9902e5e7d", "U_PLACEHOLDER_USERID1ccdbac80ea15"]);
        ...
        $expected_not_in = lineconnectTest::getExpectedLineIds(["U_PLACEHOLDER_USERID4e7a9902e5e7d", "U_PLACEHOLDER_USERIDc3f457cdefcc9", "U_PLACEHOLDER_USERID1ccdbac80ea15"]);
        ...
        $expected_between = lineconnectTest::getExpectedLineIds(["U_PLACEHOLDER_USERID4e7a9902e5e7d", "U_PLACEHOLDER_USERID1ccdbac80ea15"]);
        ...
        $expected_not_between = lineconnectTest::getExpectedLineIds(["U_PLACEHOLDER_USERIDc3f457cdefcc9", "U_PLACEHOLDER_USERID4123a772125a1"]);
        ...
        $expected_multi = lineconnectTest::getExpectedLineIds(["U_PLACEHOLDER_USERID4e7a9902e5e7d", "U_PLACEHOLDER_USERID1ccdbac80ea15"]);
    ...
    public function test_profile属性によるオーディエンスの取得_追加演算子() {
        ...
        $expected_not_equal = lineconnectTest::getExpectedLineIds(["U_PLACEHOLDER_USERID4e7a9902e5e7d", "U_PLACEHOLDER_USERIDc3f457cdefcc9", "U_PLACEHOLDER_USERID1ccdbac80ea15"]);
        ...
        $expected_greater_than = lineconnectTest::getExpectedLineIds(["U_PLACEHOLDER_USERID4e7a9902e5e7d", "U_PLACEHOLDER_USERID4123a772125a1"]);
        ...
        $expected_greater_equal = lineconnectTest::getExpectedLineIds(["U_PLACEHOLDER_USERID4e7a9902e5e7d", "U_PLACEHOLDER_USERID1ccdbac80ea15", "U_PLACEHOLDER_USERID4123a772125a1"]);
        ...
        $expected_less_than = lineconnectTest::getExpectedLineIds(["U_PLACEHOLDER_USERID4e7a9902e5e7d"]);
        ...
        $expected_less_equal = lineconnectTest::getExpectedLineIds(["U_PLACEHOLDER_USERID4e7a9902e5e7d", "U_PLACEHOLDER_USERIDc3f457cdefcc9"]);
        ...
        $expected_like = lineconnectTest::getExpectedLineIds(["U_PLACEHOLDER_USERID4e7a9902e5e7d", "U_PLACEHOLDER_USERID1ccdbac80ea15"]);
        ...
        $expected_not_like = lineconnectTest::getExpectedLineIds(["U_PLACEHOLDER_USERIDc3f457cdefcc9", "U_PLACEHOLDER_USERID4123a772125a1"]);
        ...
        $expected_regexp = lineconnectTest::getExpectedLineIds(["U_PLACEHOLDER_USERID4e7a9902e5e7d", "U_PLACEHOLDER_USERID1ccdbac80ea15", "U_PLACEHOLDER_USERID4123a772125a1"]);
        ...
        $expected_not_regexp = lineconnectTest::getExpectedLineIds(["U_PLACEHOLDER_USERIDc3f457cdefcc9"]);
        ...
        $expected_exists = lineconnectTest::getExpectedLineIds(["U_PLACEHOLDER_USERIDc3f457cdefcc9"]);
        ...
        $expected_not_exists = lineconnectTest::getExpectedLineIds(["U_PLACEHOLDER_USERID4e7a9902e5e7d", "U_PLACEHOLDER_USERID1ccdbac80ea15", "U_PLACEHOLDER_USERID4123a772125a1"]);
