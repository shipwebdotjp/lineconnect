...
class AudienceWpUserIdTest extends WP_UnitTestCase {
    ...
    public function test_WPユーザーIDによるオーディエンスの取得(){
        ...
        $actual_empty = lineconnectAudience::get_audience_by_condition($conditions_empty);
        ...
        $actual_single = lineconnectAudience::get_audience_by_condition($conditions_single);
        ...
        $actual_unlinked_user = lineconnectAudience::get_audience_by_condition($conditions_unlinked_user);
