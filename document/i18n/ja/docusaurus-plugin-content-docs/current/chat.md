...
### 2. メッセージエリア（中央ペイン）
#### メッセージ表示領域
- テキストメッセージ/画像/動画/音声/ファイル/位置情報/Imagemap/Flexメッセージを表示
- スタンプメッセージとテンプレートメッセージは、プレースホルダーの吹き出しとして表示
- メッセージバブルの左右で送受信を区別表示(左: 受信、右: 送信)
- 友だち追加/解除、参加/退出、ポストバック、Beacon検知、アカウント連携などのシステムイベントもシステム吹き出しで表示
...
- インタラクション: 紐づいたインタラクションのセッション画面を新しいタブで開く
