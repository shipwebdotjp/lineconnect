...
リッチメニュー画面の上部にはチャネル選択があり、以下の2つのタブがあります。
- リッチメニュー
- リッチメニューエイリアス
...
3. または、「リッチメニュー一覧」から「テンプレートとして使用」をクリックして、既存のリッチメニューを元に作成します。
4. リッチメニューのプロパティを設定し保存します。

## リッチメニューに画像を設定
5. 画像ファイルをドラッグ＆ドロップ、またはアップロード領域をクリックして選択します。  
...
## リッチメニューのプロパティ
### リッチメニューID
リッチメニューの一意な識別子です。ユーザーには表示されません。  
最大文字数：100文字
