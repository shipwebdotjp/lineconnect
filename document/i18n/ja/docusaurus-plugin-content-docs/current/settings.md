...
### Webhook設定
Webhook設定欄では、LINE Developers の Messaging API チャネルで使用する Webhook URL が表示されます。  
チャネルシークレットは「チャネル基本設定」ページから、チャネルアクセストークンは「Messaging API 設定」ページから取得できます。  
Webhook を利用する場合は、表示されている Webhook URL を設定してください。

## 連携
ログインページURL、リダイレクト方法、連携開始・解除のキーワード、連携開始・解除時のメッセージを変更することができます。
### ログインページURL
連携開始メッセージボタンをタップしたときに遷移するページURLです。通常ログインページのURLです。
### リダイレクトページの方法
ログイン後のリダイレクトページの扱いを選択します。
- 直接ファイルアクセス
- Admin Post
- REST API
### 自動連携開始
...
### アカウント連携・解除開始キーワード
アカウント連携または解除を開始するためのキーワードです。
### アカウント連携開始メッセージのタイトル
アカウント連携を開始するメッセージに表示されるタイトルです。
### アカウント連携開始メッセージの本文
アカウント連携を開始するメッセージに表示される本文です。
### アカウント連携開始メッセージのボタンラベル
アカウント連携を開始するメッセージに表示されるボタンラベルです。
### アカウント連携完了メッセージ
アカウント連携が完了したときに表示されるメッセージです。
### アカウント連携失敗メッセージ
アカウント連携に失敗したときに表示されるメッセージです。
### アカウント解除開始メッセージのタイトル
アカウント解除を開始するメッセージに表示されるタイトルです。
### アカウント解除開始メッセージの本文
アカウント解除を開始するメッセージに表示される本文です。
### アカウント解除開始メッセージのボタンラベル
アカウント解除を開始するメッセージに表示されるボタンラベルです。
### アカウント解除完了メッセージ
アカウント解除が完了したときに表示されるメッセージです。
### アカウント解除失敗メッセージ
アカウント解除に失敗したときに表示されるメッセージです。
## 更新通知
### 投稿タイプ
...
## データ
### リッチメニューキャッシュを削除
LINE Connect が保持しているリッチメニューキャッシュを削除して、API などで行った更新を反映させるためのボタンです。
### プラグインデータをすべて削除
LINE Connect が保持しているプラグインデータをすべて削除します。
