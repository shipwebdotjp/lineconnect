...
class AudienceRoleTest extends WP_UnitTestCase {
    ...
    public function test_ロールによるオーディエンス取得(){
        ...
        $single_line_ids = lineconnectAudience::get_audience_by_condition($condition_single['condition']);
        ...
        $nonexistent_line_ids = lineconnectAudience::get_audience_by_condition($condition_nonexistent['condition']);
        ...
        $nonexistent_multiple_line_ids = lineconnectAudience::get_audience_by_condition($condition_nonexistent_multiple['condition']);
        ...
        $multiple_line_ids = lineconnectAudience::get_audience_by_condition($condition_multiple['condition']);
        // 結果を確認する
        ...
        $role_in_line_ids = lineconnectAudience::get_audience_by_condition($condition_role_in['condition']);
        ...
        $role_not_in_line_ids = lineconnectAudience::get_audience_by_condition($condition_role_not_in['condition']);
        // 結果を確認する
        ...
        $complex_line_ids = lineconnectAudience::get_audience_by_condition($condition_complex['condition']);
        // 結果を確認する
        ...
        $complex_role_or_role_line_ids = lineconnectAudience::get_audience_by_condition($condition_complex_role_or_role['condition']);
