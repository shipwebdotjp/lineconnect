...
class AudienceNestedTest extends WP_UnitTestCase {
    ...
    public function test_ネストした条件よるオーディエンスの取得(){
        ...
        $this->assertEmpty(lineconnectAudience::get_audience_by_condition($condition_empty), '空のネストした条件の場合、空のオーディエンスを返すことを確認');
        ...
        $actual_and_group_of_or = lineconnectAudience::get_audience_by_condition($condition_and_group_of_or);
