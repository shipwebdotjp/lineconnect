# Action-related filters
This group contains hooks used to extend or customize actions used by AI responses and triggers.

## Included hooks

- [slc_filter_actions](#slc_filter_actions): Register custom actions for AI responses and triggers.
