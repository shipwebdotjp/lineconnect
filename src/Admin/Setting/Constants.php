			...
			array(
				...
				'connect' => array(
					...
					'fields' => array(
						...
						'redirect_page_method'  => array(
							'type'     => 'select',
							'label'    => __( 'Redirect page method', lineconnect::PLUGIN_NAME ),
							'required' => false,
							'default'  => 'file',
							'hint'     => __( 'Select the method for handling redirects after login.', lineconnect::PLUGIN_NAME ),
							'list'     => array(
								'file'      => __( 'Direct file access', lineconnect::PLUGIN_NAME ),
								'adminpost' => __( 'Admin Post', lineconnect::PLUGIN_NAME ),
								'restapi'   => __( 'REST API', lineconnect::PLUGIN_NAME ),
							),
						),
