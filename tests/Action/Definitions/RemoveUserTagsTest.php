...
class RemoveUserTagsTest extends WP_UnitTestCase {
    ...
    public function test_remove_tags() {
        ...
        $addTagsFunc->set_event((object) array("source" => (object) array("userId" => "Ud2be13c6f39c97f05c683d92c696483b")));
        ...
        $removeTagsFunc->set_event((object) array("source" => (object) array("userId" => "Ud2be13c6f39c97f05c683d92c696483b")));
