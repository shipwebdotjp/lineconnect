...
const poFile = path.resolve(__dirname, 'languages/line-interaction-ja.po');
const jsonFile = path.resolve(__dirname, 'languages/lineconnect-ja-slc_interaction.json');
