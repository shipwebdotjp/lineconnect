...
class Trigger {
	...
	static function get_schema() {
																	...
																	array(
																		'properties' => array(
																			...
																			'usermeta' => array(
																				...
																				'items' => array(
																					'type' => 'object',
																					'required' => array( 'key', 'value', 'compare' ),
																					'properties' => array(
																						'key' => array(
																							'type' => 'string',
		...
		foreach ( self::get_types() as $type => $type_schema ) {
			...
			} elseif ( 'action_hook' === $type ) {
				$trigger_schema_bytype[ $type ]['properties']['audience_mode'] = array(
					'type'        => 'string',
					'title'       => __( 'Audience mode', lineconnect::PLUGIN_NAME ),
					'description' => __( 'Choose recipients for LINE messages', lineconnect::PLUGIN_NAME ),
					'oneOf'       => array(
						array(
							'const' => 'current_user',
							'title' => __( 'Use related user', lineconnect::PLUGIN_NAME ),
						),
						array(
							'const' => 'standard',
							'title' => __( 'Specify audience', lineconnect::PLUGIN_NAME ),
						),
					),
				);
				$trigger_schema_bytype[ $type ]['dependencies']                = array(
					'audience_mode' => array(
						'oneOf' => array(
							array(
								'properties' => array(
			...
			'action_hook' => array(
				...
				'properties'   => array(
					'hook' => array(
						'type'        => 'string',
						'title'       => __( 'Event type', lineconnect::PLUGIN_NAME ),
						'description' => __( 'WordPress action hook to trigger on', lineconnect::PLUGIN_NAME ),
						'oneOf'       => array(
							array(
								'const' => 'user_register',
								'title' => __( 'User registration', lineconnect::PLUGIN_NAME ),
							),
							array(
								'const' => 'wp_login',
								'title' => __( 'Login', lineconnect::PLUGIN_NAME ),
							),
							array(
								'const' => 'wp_logout',
								'title' => __( 'Logout', lineconnect::PLUGIN_NAME ),
							),
							array(
								'const' => 'profile_update',
								'title' => __( 'Profile update', lineconnect::PLUGIN_NAME ),
							),
							array(
								'const' => 'delete_user',
								'title' => __( 'User deletion', lineconnect::PLUGIN_NAME ),
							),
							array(
								'const' => 'save_post',
								'title' => __( 'Post saved', lineconnect::PLUGIN_NAME ),
							),
							array(
								'const' => 'comment_post',
								'title' => __( 'Comment posted', lineconnect::PLUGIN_NAME ),
							),
							array(
								'const' => 'activated_plugin',
								'title' => __( 'Plugin activated', lineconnect::PLUGIN_NAME ),
							),
							array(
								'const' => 'deactivated_plugin',
								'title' => __( 'Plugin deactivated', lineconnect::PLUGIN_NAME ),
							),
							array(
								'const' => 'switch_theme',
								'title' => __( 'Theme switched', lineconnect::PLUGIN_NAME ),
							),
						),
					),
				),
				'dependencies' => array(
					'hook' => array(
						'oneOf' => array(
								...
								'properties' => array(
									...
									'save_post' => array(
										...
										'properties' => array(
											'post_type'   => array(
												'type'    => 'array',
												'title'   => __( 'Post types', lineconnect::PLUGIN_NAME ),
												'items'   => array( 'type' => 'string' ),
												'default' => array( 'post', 'page' ),
											),
											'post_status' => array(
												'type'    => 'array',
												'title'   => __( 'Post status', lineconnect::PLUGIN_NAME ),
												'items'   => array( 'type' => 'string' ),
												'default' => array( 'publish', 'draft', 'pending' ),
											),
										),
									),
								),
							...
							array(
								'properties' => array(
									'hook'         => array( 'const' => 'comment_post' ),
									'comment_post' => array(
										'type'       => 'object',
										'properties' => array(
											'post_type' => array(
												'type'  => 'array',
												'title' => __( 'Target post types', lineconnect::PLUGIN_NAME ),
												'items' => array( 'type' => 'string' ),
											),
										),
									),
			...
			'properties' => array(
				'type' => array(
					...
					'oneOf' => array(
						...
						array(
							'const' => 'action_hook',
							'title' => __( 'Action Hook', lineconnect::PLUGIN_NAME ),
						),
					),
				),
			),
