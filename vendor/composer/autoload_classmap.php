...
return array(
    'ActionExecuteAjaxActionExecuteTest' => $baseDir . '/tests/ActionExecute/ActionExecuteAjaxActionExecuteTest.php',
    'ActionFlowAjaxChatSendTest' => $baseDir . '/tests/ActionFlow/ActionFlowAjaxChatSendTest.php',
    'ActionRunnerTest' => $baseDir . '/tests/Interaction/ActionRunnerTest.php',
    'AddUserTagsTest' => $baseDir . '/tests/Action/Definitions/AddUserTagsTest.php',
    'Attribute' => $vendorDir . '/symfony/polyfill-php80/Resources/stubs/Attribute.php',
    'AudienceBasicTest' => $baseDir . '/tests/audience/AudienceBasicTest.php',
    'AudienceChannelTest' => $baseDir . '/tests/audience/AudienceChannelTest.php',
    'AudienceComplexConditionsTest' => $baseDir . '/tests/audience/AudienceComplexConditionsTest.php',
    'AudienceFieldsTest' => $baseDir . '/tests/audience/AudienceFieldsTest.php',
    'AudienceLineUserIdTest' => $baseDir . '/tests/audience/AudienceLineUserIdTest.php',
    'AudienceLinkTest' => $baseDir . '/tests/audience/AudienceLinkTest.php',
    'AudienceNestedTest' => $baseDir . '/tests/audience/AudienceNestedTest.php',
    'AudienceProfileTest' => $baseDir . '/tests/audience/AudienceProfileTest.php',
    'AudienceRoleTest' => $baseDir . '/tests/audience/AudienceRoleTest.php',
    'AudienceUserMetaTest' => $baseDir . '/tests/audience/AudienceUserMetaTest.php',
    'AudienceWpUserIdTest' => $baseDir . '/tests/audience/AudienceWpUserIdTest.php',
    'BulkmessageAjaxChatSendFailTest' => $baseDir . '/tests/bulkmessage/BulkmessageAjaxChatSendFailTest.php',
    'BulkmessageAjaxChatSendTest' => $baseDir . '/tests/bulkmessage/BulkmessageAjaxChatSendTest.php',
    'CancelInteractionTest' => $baseDir . '/tests/Action/Definitions/CancelInteractionTest.php',
    'ChannelTest' => $baseDir . '/tests/core/ChannelTest.php',
    'ChatSendTest' => $baseDir . '/tests/Chat/API/ChatSendTest.php',
    'Composer\\InstalledVersions' => $vendorDir . '/composer/InstalledVersions.php',
    'DataDeleteTest' => $baseDir . '/tests/Admin/Setting/DataDeleteTest.php',
    'EditUserDataTest' => $baseDir . '/tests/Chat/API/EditUserDataTest.php',
    'ExecuteScenarioStepTest' => $baseDir . '/tests/scenario/ExecuteScenarioStepTest.php',
    'FetchMessagesMultiPageTest' => $baseDir . '/tests/Chat/API/FetchMessagesMultiPageTest.php',
    'FetchMessagesOnePageTest' => $baseDir . '/tests/Chat/API/FetchMessagesOnePageTest.php',
    'FetchUserDataTest' => $baseDir . '/tests/Chat/API/FetchUserDataTest.php',
    'FetchUsersMultiPageTest' => $baseDir . '/tests/Chat/API/FetchUsersMultiPageTest.php',
    'FetchUsersOnePageTest' => $baseDir . '/tests/Chat/API/FetchUsersOnePageTest.php',
    'GetMyUserInfoTest' => $baseDir . '/tests/Action/Definitions/GetMyUserInfoTest.php',
    'GetUserProfileValueTest' => $baseDir . '/tests/Action/Definitions/GetUserProfileValueTest.php',
    'InputNormalizerTest' => $baseDir . '/tests/Interaction/InputNormalizerTest.php',
    'InteractionDefinitionTest' => $baseDir . '/tests/Interaction/InteractionDefinitionTest.php',
    'InteractionHandlerBranchByPostbackTest' => $baseDir . '/tests/Interaction/InteractionHandlerBranchByPostbackTest.php',
    'InteractionHandlerBranchByTextTest' => $baseDir . '/tests/Interaction/InteractionHandlerBranchByTextTest.php',
    'InteractionHandlerExtractUserInputTest' => $baseDir . '/tests/Interaction/InteractionHandlerExtractUserInputTest.php',
    'InteractionManager_Base' => $baseDir . '/tests/Interaction/InteractionManager_Base.php',
    'InteractionManager_CancelTest' => $baseDir . '/tests/Interaction/InteractionManager_CancelTest.php',
    'InteractionManager_ConfirmTest' => $baseDir . '/tests/Interaction/InteractionManager_ConfirmTest.php',
    'InteractionManager_DuplicateTest' => $baseDir . '/tests/Interaction/InteractionManager_DuplicateTest.php',
    'InteractionManager_PauseResumeTest' => $baseDir . '/tests/Interaction/InteractionManager_PauseResumeTest.php',
    'InteractionManager_ReminderTest' => $baseDir . '/tests/Interaction/InteractionManager_ReminderTest.php',
    'InteractionManager_SingleTest' => $baseDir . '/tests/Interaction/InteractionManager_SingleTest.php',
    'InteractionManager_ValidateTest' => $baseDir . '/tests/Interaction/InteractionManager_ValidateTest.php',
    'InteractionManager_quickReplyTest' => $baseDir . '/tests/Interaction/InteractionManager_quickReplyTest.php',
    'InteractionSessionTest' => $baseDir . '/tests/Interaction/InteractionSessionTest.php',
    'LINE\\Tests\\LINEBot\\Util\\DummyHttpClient' => $baseDir . '/tests/LINEBot/Util/DummyHttpClient.php',
    'LineConnectActivationTest' => $baseDir . '/tests/core/LineConnectActivationTest.php',
    'LineConnectVariableTest' => $baseDir . '/tests/core/LineConnectVariableTest.php',
    'LoggerTest' => $baseDir . '/tests/Message/LINE/LoggerTest.php',
    'OptionTest' => $baseDir . '/tests/core/OptionTest.php',
    ...
    'RemoveUserTagsTest' => $baseDir . '/tests/Action/Definitions/RemoveUserTagsTest.php',
    'RunPolicyEnforcerTest' => $baseDir . '/tests/Interaction/RunPolicyEnforcerTest.php',
    'SampleTest' => $baseDir . '/tests/SampleTest.php',
    'SavePostByAudienceTest' => $baseDir . '/tests/Publish/SavePostByAudienceTest.php',
    'SavePostTest' => $baseDir . '/tests/Publish/SavePostTest.php',
    'ScenarioDataLoadSaveTest' => $baseDir . '/tests/scenario/ScenarioDataLoadSaveTest.php',
    'ScenarioScheduleTest' => $baseDir . '/tests/scenario/ScenarioScheduleTest.php',
    ...
    'SessionRepositoryTest' => $baseDir . '/tests/Interaction/SessionRepositoryTest.php',
    'SetScenarioStepTest' => $baseDir . '/tests/scenario/SetScenarioStepTest.php',
    'Shipweb\\LineConnect\\Tests\\Interaction\\Manage\\rest_api_get_interaction_Test' => $baseDir . '/tests/Interaction/Manage/rest_api_get_interaction_Test.php',
    'Shipweb\\LineConnect\\Tests\\Interaction\\MessageBuilderTest' => $baseDir . '/tests/Interaction/MessageBuilderTest.php',
    'ShowSendCheckboxTest' => $baseDir . '/tests/Publish/ShowSendCheckboxTest.php',
    'StartInteractionTest' => $baseDir . '/tests/Action/Definitions/StartInteractionTest.php',
    'StorageSaveToProfileTest' => $baseDir . '/tests/Interaction/StorageSaveToProfileTest.php',
    ...
    'UpdateUserMetaTest' => $baseDir . '/tests/Action/Definitions/UpdateUserMetaTest.php',
    'UpdateUserProfileTest' => $baseDir . '/tests/Action/Definitions/UpdateUserProfileTest.php',
    'UpdateUserTagsTest' => $baseDir . '/tests/Action/Definitions/UpdateUserTagsTest.php',
    'UserTest' => $baseDir . '/tests/core/UserTest.php',
    'UtilConditionChannelTest' => $baseDir . '/tests/util/UtilConditionChannelTest.php',
    'UtilConditionCompareTest' => $baseDir . '/tests/util/UtilConditionCompareTest.php',
    'UtilConditionDestinationTest' => $baseDir . '/tests/util/UtilConditionDestinationTest.php',
    'UtilConditionGroupTest' => $baseDir . '/tests/util/UtilConditionGroupTest.php',
    'UtilConditionLinkTest' => $baseDir . '/tests/util/UtilConditionLinkTest.php',
    'UtilConditionProfileTest' => $baseDir . '/tests/util/UtilConditionProfileTest.php',
    'UtilConditionRoleTest' => $baseDir . '/tests/util/UtilConditionRoleTest.php',
    'UtilConditionUserMetaTest' => $baseDir . '/tests/util/UtilConditionUserMetaTest.php',
    'UtilHasObjectPlaceholderTest' => $baseDir . '/tests/util/UtilHasObjectPlaceholderTest.php',
    ...
    'ValidatorTest' => $baseDir . '/tests/Interaction/ValidatorTest.php',
    ...
    'rest_api_delete_session_Test' => $baseDir . '/tests/Interaction/Manage/rest_api_delete_session_Test.php',
    'rest_api_delete_sessions_bulk_Test' => $baseDir . '/tests/Interaction/Manage/rest_api_delete_sessions_bulk_Test.php',
    'rest_api_download_sessions_csv_Test' => $baseDir . '/tests/Interaction/Manage/rest_api_download_sessions_csv_Test.php',
    'rest_api_get_sessions_by_interaction_Test' => $baseDir . '/tests/Interaction/Manage/rest_api_get_sessions_by_interaction_Test.php',
    'rest_api_update_session_Test' => $baseDir . '/tests/Interaction/Manage/rest_api_update_session_Test.php',
);
